...
class Evaluate(object):
    ...
    def _read_data(self):
        ...
        self.host_times_d = {}
        self.host_label_d = {}
        file_list = utils.search_files(CONFIG.PATH_RAW + "/competition/agg/", includes=["_1_", "feats", ".npy"], excludes=[], type="file")
        time_list = utils.search_files(CONFIG.PATH_RAW + "/competition/agg/", includes=["_1_", "labels", ".npy"], excludes=[], type="file")
